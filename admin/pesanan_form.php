...
<form action="pesanan_controller.php" method="POST">
      <div class="form-group row">
        ...
        <div class="col-8">
          <input id="tanggal" name="tanggal" type="text" class="form-control" value="<?= $pesanan['tanggal']?>">
        </div>
      </div>
      <div class="form-group row">
      ...
      <div class="form-group row">
        <label for="text3" class="col-4 col-form-label">Dibayar</label> 
        <div class="col-8">
          <input id="dibayar" name="dibayar" type="text" class="form-control" value="<?= $pesanan['dibayar']?>">
        </div>
      </div>
      <div class="form-group row">
